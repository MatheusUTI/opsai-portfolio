...
export default function Impact() {
  const indicators = [
    {
      value: "+7",
      label: "Motoristas coordenados diariamente",
    },
    {
      value: "95%+",
      label: "Meta operacional de performance de entregas",
    },
    {
      value: "10+",
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
        ...
        <div className="md:col-span-3 flex flex-col justify-between h-auto gap-4">
          <div>
            ...
            <p className="font-serif text-sm text-[#444748] mt-4 leading-relaxed max-w-xs">
              Experiência prática aplicada diariamente em operações logísticas reais.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {indicators.map((ind, idx) => (
              ...
              >
                ...
                <p className="font-serif text-sm md:text-base text-[#444748] leading-relaxed">
                  {ind.label}
                </p>
              </div>
            ))}
